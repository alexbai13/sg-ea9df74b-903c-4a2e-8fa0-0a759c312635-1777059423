      ...
      <motion.header
        ...
        <div className="container flex items-center justify-between h-20 md:h-24 lg:h-28">
          <Link href="/" className="flex items-center focus:outline-none focus:ring-2 focus:ring-primary rounded-lg transition-transform hover:scale-[1.02]" onClick={() => setMobileOpen(false)}>
            <div className="relative h-24 md:h-32 lg:h-40 w-auto" style={{ width: "500px" }}>
              <Image
                src="/logo_andalu.png"
          ...
          <nav className="hidden xl:flex items-center gap-8" role="navigation" aria-label="Navegación principal">
            ...
            <button
              ...
              className="text-[15px] font-semibold text-muted-foreground hover:text-primary transition-colors relative group focus:outline-none focus:text-primary" style={{ fontSize: "18px" }}>
