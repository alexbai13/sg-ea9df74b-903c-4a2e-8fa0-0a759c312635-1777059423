      ...
      <div className="container relative z-10">
        <motion.div
          ...
          <motion.span
            ...
            className="inline-block bg-primary/10 text-primary text-base font-medium px-5 py-2 rounded-full mb-5" style={{ fontSize: "18px" }}>
        ...
        <motion.p
          ...
          className="text-center text-base text-muted-foreground mt-12 bg-card border border-border rounded-2xl py-5 px-7 max-w-2xl mx-auto" style={{ fontSize: "18px" }}>
