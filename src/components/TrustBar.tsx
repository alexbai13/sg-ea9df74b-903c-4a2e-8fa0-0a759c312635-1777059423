    ...
    <section className="py-10 md:py-14 border-b border-border/50 bg-background relative overflow-hidden">
      <div className="container">
        <motion.p
          ...
          className="text-center text-sm font-medium text-muted-foreground mb-8 uppercase tracking-widest" style={{ fontSize: "18px" }}>
        ...
        <motion.div
          ...
          <div key={stat.label} className="px-2 md:px-4 min-w-[100px]">
              ...
              <p className="text-[11px] sm:text-xs text-muted-foreground mt-1" style={{ fontSize: "16px" }}>{stat.label}</p>
            </div>
          )}
        </motion.div>
      </div>
